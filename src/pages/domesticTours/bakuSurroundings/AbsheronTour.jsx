  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        >
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white">Abşeron Yarımadası Turu</h1>
            <p className="mt-4 text-xl text-slate-300">"Odlar Yurdu"-nun qədim sirlərinə səyahət</p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 p-6 bg-slate-800 rounded-2xl border border-slate-700 text-center">
          ...
          <div className="text-white"><Users className="mx-auto w-8 h-8 mb-2 text-cyan-400" /> <span className="font-semibold">Tarix Həvəskarları</span></div>
          ...
          <div className="text-white"><Star className="mx-auto w-8 h-8 mb-2 text-cyan-400" /> <span className="font-semibold">Mistik Təcrübə</span></div>
        </div>
          ...
          <div className="w-full lg:w-2/3">
            <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-slate-300 leading-relaxed">
                Bu tur sizi Bakının şəhər səs-küyündən uzaqlaşdıraraq, Abşeron yarımadasının mistik və tarixi məkanlarına aparacaq. Qədim Zərdüştilərin ibadət yeri olan, yerdən çıxan təbii qazın alovlandığı Atəşgah məbədini ziyarət edəcəyik. Daha sonra, əsrlərdir sönməyən və insanı heyrətə gətirən təbiət möcüzəsi Yanardağa yollanacağıq. Bu səyahət sizə Azərbaycanın niyə "Odlar Yurdu" adlandırıldığını əyani şəkildə göstərəcək.
              </p>
            </motion.div>
            ...
            <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.7 }} className="mt-12">
                ...
                <div className="space-y-2">
                    <AccordionItem title="Başlanğıc - Oteldən Götürülmə">
                        Turumuz sizi Bakı şəhəri daxilində təyin etdiyiniz ünvandan və ya oteldən komfortlu nəqliyyatla götürməklə başlayır.
                    </AccordionItem>
                    <AccordionItem title="Atəşgah Məbədi">
                        Suraxanıda yerləşən bu tarixi məbəd kompleksi ilə tanış oluruq. Bələdçimiz məbədin tarixi, Zərdüştilik və burada ibadət edən hindli tacirlər haqqında sizə ətraflı məlumat verəcək.
                    </AccordionItem>
                    <AccordionItem title="Yanardağ">
                        Dağın ətəyində əsrlərdir sönməyən təbii alovu müşahidə edirik. Bu heyrətamiz mənzərə qarşısında unudulmaz fotolar çəkmək imkanınız olacaq.
                    </AccordionItem>
                     <AccordionItem title="Qala Arxeoloji-Etnoqrafik Muzeyi (İstəyə bağlı)">
                        Yolüstü, qədim Abşeron kəndlərinin həyat tərzini əks etdirən bu açıq səma altındakı muzeyi ziyarət etmək imkanımız olacaq.
                    </AccordionItem>
                    <AccordionItem title="Geri Qayıdış - Otelə Buraxılma">
                        Turun sonunda sizi götürdüyümüz ünvana və ya otelinizə geri qaytarırıq.
                    </AccordionItem>
                </div>
            </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                      ...
                      <ul className="space-y-3">
                          ...
                          <li className="flex items-center text-slate-300"><CheckCircle className="w-5 h-5 mr-3 text-green-500" />Atəşgah və Yanardağa giriş biletləri</li>
                   ...
                   <div>
                      ...
                      <ul className="space-y-3">
                          <li className="flex items-center text-slate-300"><XCircle className="w-5 h-5 mr-3 text-red-500" />Qala muzeyinə giriş bileti</li>
          ...
          <div className="w-full lg:w-1/3">
            ...
            >
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-cyan-400">$65</span>
                <span className="text-slate-400 ml-2">/nəfər</span>
              </div>
              <p className="text-center text-slate-300 mb-6">"Odlar Yurdu"-nun alovlu ürəyinə səyahət etmək üçün yerinizi indidən rezerv edin!</p>
